...
export async function getWeatherByCity({ latitude, longitude }: GetWeatherByCityProps): Promise<GetWeatherByCityResponseProps> {
  ...
  //o conteúdo de data pode ser visualizado dentro de network no devtools, depois clicar em forecast?lat=..., depois abrir a aba response e copiar todo o conteúdo desta aba e colar no site https://transform.tools/json-to-typescript para obter a tipagem deste objeto
